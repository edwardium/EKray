...
- 🟩 Core Engine
    - انتخاب و پیاده‌سازی sing-box
    - نصب و راه‌اندازی خودکار (یک‌خطی)
    - نصب پیش‌نیازها (curl, wget, ...)
- 🛠 User Management
    - افزودن/حذف یوزر
    - ساخت QR/لینک اختصاصی
    - محدودیت حجم/دستگاه
- 🔗 Protocols
    - Reality
    - VLESS
